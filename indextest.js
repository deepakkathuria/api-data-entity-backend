...
const fetchAllMatchIds = async () => {
    try {
        // Fetch all documents from the Liveinfo collection
        const matches = await Liveinfo.find({}).select('match_id -_id'); // Selects only the 'match_id' field and excludes the MongoDB '_id' field
...
// Example usage
fetchAllMatchIds().then(matchIds => {
